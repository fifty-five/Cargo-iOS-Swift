...
class AppDelegate: UIResponder, UIApplicationDelegate, TAGContainerOpenerNotifier {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.fiftyfive.SwiftSampleApp" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("SwiftSampleApp", withExtension: "momd")!
